...
| Complaint, NCR and CAPA    | `complaint:read`, `ncr:read`, `capa:read`                                | complaint create/triage/assign/close, NCR manage/disposition/close, CAPA manage/verify | `quality-warehouse`       | User-facing             |
