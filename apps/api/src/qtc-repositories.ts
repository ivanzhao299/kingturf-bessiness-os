...
export class PostgresQuoteToCashRepository {
  ...
  public async list(
    view: 'credit' | 'contracts' | 'orders' | 'ar' | 'payments' | 'reconciliation',
    context: Context,
  ) {
