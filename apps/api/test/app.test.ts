...
import type { AuthorizationContext, EmployeeRepository, OrganizationRepository } from '@kingturf/domain';
...
function dependencies(authContext:AuthorizationContext|null){
  ...
  return {auth,organizations,employees,logout};
}
